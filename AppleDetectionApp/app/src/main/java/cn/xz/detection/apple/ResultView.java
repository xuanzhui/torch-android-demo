...
public class ResultView extends View {
    ...
    private ArrayList<PrePostProcessor.Result> mResults;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (PrePostProcessor.Result result : mResults) {
    ...
    public void setResults(ArrayList<PrePostProcessor.Result> results) {
        mResults = results;
    }
}
